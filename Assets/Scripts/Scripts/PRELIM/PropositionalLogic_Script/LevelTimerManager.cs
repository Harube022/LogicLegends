...
//     // NEW: Persistent global timer value tracking remaining seconds across scene reloads
...
//     /// <summary>
//     /// Initializes or restores the global level timer countdown.
//     /// </summary>
//     public void StartLevelTimer()
//     {
//         if (isRespawningFromFail && savedRemainingTime > 0)
//         {
//             // Recover exactly where the countdown timer was prior to failure
//             currentTimer = savedRemainingTime;
//         }
//         else
//         {
//             // Fresh level start from the beginning
...
//             // Keep the static backup updated in case of unexpected event triggers
...
//         // CRITICAL CHANGE: We DO NOT set isRespawningFromFail here anymore! 
//         // Dying by trap means resetting room layout. Running out of time means Game Over.
//         // Instead, we give them a specific amount of time to retry the current room (e.g., 60s baseline check)
//         isRespawningFromFail = true;
        
//         // Give them a refreshed baseline amount of time so they can actually solve the challenge they failed on
//         savedRemainingTime = 60f; 
